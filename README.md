...
本项目从政府网站公开 HTML 页面和 PDF、DOCX、XLSX、TXT 等附件中，建立可审计的“莱西—莱阳跨域合作”政策与实施证据库。发现阶段采用宽口径，不要求标题出现“一体化”；凡同时出现莱阳与莱西、同时出现青岛与烟台，或涉及青岛都市圈、胶东经济圈、山东半岛城市群的政府公开资料均进入候选库。分类阶段再依据涉及主体、空间关系、任务安排和跨域治理内容进行 A–D 分级。项目不使用或虚构统一 API。
